...
def venues():
  ...
  for area in areas:
    ...
    venues = [dict(v) for v in query_result]
    area['venues'] = venues
  # data=[{
  #   "city": "San Francisco",
  #   "state": "CA",
...
def search_venues():
  ...
  response = [dict(v) for v in query_result]
  response = {'count': len(response), 'data': response}
  # response={
  #   "count": 1,
  #   "data": [{
  #     "id": 2,
...
def search_artists():
  ...
  response = [dict(a) for a in query_result]
  response = {'count': len(response), 'data': response}
  # response={
  #   "count": 1,
  #   "data": [{
